...
<div class="container">
    ...
    echo form_input('first_name',set_value('first_name'),"class='form-control'").'<br />';
    echo form_label('Last name:','last_name').'<br />';
    echo form_error('last_name');
    echo form_input('last_name',set_value('last_name'),"class='form-control'").'<br />';
    ...
    echo form_submit('register','Register',"class='btn btn-outline-primary'");
    echo form_close();
    ?>
</div>